...
class _Load implements ScheduleEvent {
  const _Load();
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<Course> courses)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
return loaded(_that.courses);case _Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<Course> courses)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading();case _Loaded():
return loaded(_that.courses);case _Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<Course> courses)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
...
class _Initial implements ScheduleState {
  const _Initial();
...
class _Loading implements ScheduleState {
  const _Loading();
...
class _Loaded implements ScheduleState {
  const _Loaded(final  List<Course> courses): _courses = courses;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&const DeepCollectionEquality().equals(other._courses, _courses));
}
...
@override
String toString() {
  return 'ScheduleState.loaded(courses: $courses)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $ScheduleStateCopyWith<$Res> {
...
class _Error implements ScheduleState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ScheduleStateCopyWith<$Res> {
