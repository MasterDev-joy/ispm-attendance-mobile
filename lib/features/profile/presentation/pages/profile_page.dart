                    ...
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                          ...
                          // ── Carte identité ─────────────────────────
                          _stagger(0, _IdentityCard(
                              user: user, role: role, accent: accent)),
        ...
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(
                ...
                style: TextStyle(fontFamily: 'Poppins', fontSize: 12,
                    color: ISPMColors.white.withOpacity(0.45), height: 1.6)),
            const SizedBox(height: 20),
            GestureDetector(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(children: [
        ...
        const Expanded(child: Text('Mon profil',
...
class _IdentityCard extends StatelessWidget {
  ...
  final UserRole role;
  final Color    accent;
  const _IdentityCard({required this.user, required this.role,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: accent.withOpacity(0.10),
        ...
        Stack(alignment: Alignment.bottomRight, children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: accent.withOpacity(0.50), width: 2.5),
              boxShadow: [BoxShadow(color: accent.withOpacity(0.20),
...
class _RoleMetrics extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = switch (role) {
      UserRole.professor => [
        _MetricItem(icon: Icons.calendar_today_rounded,
            value: '—', label: 'Cours cette semaine'),
        _MetricItem(icon: Icons.check_circle_outline_rounded,
            value: '—', label: 'Taux de présence'),
        _MetricItem(icon: Icons.qr_code_rounded,
            value: '—', label: 'QR générés'),
      ],
      UserRole.supervisor => [
        _MetricItem(icon: Icons.qr_code_scanner_rounded,
            value: '—', label: 'Scans aujourd\'hui'),
        _MetricItem(icon: Icons.verified_rounded,
            value: '—', label: 'Cours validés'),
        _MetricItem(icon: Icons.warning_amber_rounded,
            value: '—', label: 'Non couverts'),
      ],
      UserRole.admin => [
        _MetricItem(icon: Icons.group_rounded,
            value: '—', label: 'Utilisateurs'),
        _MetricItem(icon: Icons.calendar_month_rounded,
            value: '—', label: 'Cours planifiés'),
        _MetricItem(icon: Icons.trending_up_rounded,
            value: '—', label: 'Taux global'),
      ],
    };
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          trailing ?? Icon(Icons.chevron_right_rounded,
              size: 18, color: ISPMColors.white.withOpacity(0.25)),
        ]),
      ),
    );
  }
...
class _ProfileMenuToggle extends StatelessWidget {
  ...
  const _ProfileMenuToggle({
    ...
    required this.accent, required this.value, required this.onChanged,
  });
