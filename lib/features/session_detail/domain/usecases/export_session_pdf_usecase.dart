// domain/usecases/export_session_pdf.dart
import 'dart:io';
...
class ExportSessionPdfUsecase {
  Future<Either<Failure, Unit>> call(ExportSessionPdfParams params) async {
    try {
  ...
  // ─── Builders privés (logique PDF isolée) ────────────────────────────
